        ...
        <div className="max-w-3xl mx-auto px-6 py-14">
          ...
          <div className="mt-8 space-y-6 text-sm text-neutral-700 leading-relaxed">
            <section>
              ...
              <p>
                본 약관은 에이원스마트부동산중개법인 주식회사(이하 “회사”, 사업자등록번호
                845-86-00635)가 제공하는
                AI 부동산 분석 플랫폼 “A1Smart”(이하 “서비스”)의 이용 조건
                및 절차, 회사와 회원의 권리·의무·책임을 규정함을 목적으로
                합니다.
              </p>
            </section>
            ...
            <section>
              ...
              <p>
                ...
                자동화에 의한 <strong>참고용 정보</strong>입니다. 실제 투자·매수
                결정 전 반드시 변호사·세무사·법무사 등 전문가의 검토를 받으시기
                바랍니다.
              </p>
            </section>
            ...
            <section>
              ...
              <ul className="list-disc list-inside space-y-1 text-neutral-600">
                ...
                <li>서비스 이용 중 알게 된 타인의 정보를 외부 유출하지 않을 것</li>
                <li>분석보고서를 회사 동의 없이 영리 목적으로 재배포하지 않을 것</li>
              </ul>
            </section>
            ...
            <section className="border-t pt-6">
              <p className="text-xs text-neutral-400 italic">
                ※ 본 약관은 초안입니다. 정식 시행 전 변호사 검토를 거친
                최종본으로 교체됩니다. 문의는{" "}
