      ...
      <section className="bg-[#050F2C] border-b border-white/10">
        <div className="max-w-5xl mx-auto px-6 py-12">
          ...
          <h1 className="text-3xl font-bold tracking-tight text-white">
            매수 의뢰 — <span className="text-yellow-300">매매 · 전세 · 월세</span>
          </h1>
        ...
        <div className="max-w-5xl mx-auto px-6 py-10 grid lg:grid-cols-3 gap-8">
          ...
          <div className="lg:col-span-1 space-y-4">
            ...
            <div className="bg-cyan-400/5 border border-cyan-400/20 rounded-lg p-4 text-xs text-cyan-100 leading-relaxed space-y-2">
              <div>
                <strong className="text-yellow-300">매매</strong> — 예산
                상·하한, 희망 면적·층·준공 조건
              </div>
              <div>
                <strong className="text-yellow-300">전세</strong> — 보증금
                상한 (전세가율 고려해 자동 매칭)
              </div>
              <div>
                <strong className="text-yellow-300">월세</strong> — 보증금 +
                월세 한도
              </div>
              <div className="pt-2 border-t border-cyan-400/20 text-cyan-100/70">
